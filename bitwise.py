...
# upload image
img1 = cv2.imread('/Users/amourlee/Desktop/test.jpg')
img2 = cv2.imread('/Users/amourlee/Desktop/opencv.png')
...
mask2 = cv2.cvtColor(img2, cv2.COLOR_BGR2HSV)
cv2.imshow("HSV", mask2)
